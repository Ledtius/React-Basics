 ...
 */
  ...
  const studentHowPassed = students.filter((student) => student.grade >= 14);
  console.log(studentHowPassed);
  ...
  const greaterThanEighteen = students.some((student) => student.grade > 18);
